...
describe('validateActualiteSearch', () => {
  it('validates deal and bank', () => {
    expect(
      validateActualiteSearch({ deal: 'd01', bank: 'rothschild-co' }),
    ).toEqual({ deal: 'd01', bank: 'rothschild-co' });
  });
  ...
  it('combines deal, bank and sector', () => {
    expect(
      validateActualiteSearch({ deal: 'd01', bank: 'bnp-paribas', sector: 'sante' }),
    ).toEqual({ deal: 'd01', bank: 'bnp-paribas', sector: 'sante' });
  });
});
