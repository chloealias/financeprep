...
export function SectorsTab () {
  ...
  const selectedSector =
    sectorFromUrl && isValidSectorId(sectorFromUrl) ? sectorFromUrl : null;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <Suspense
        fallback={
          <div className="h-64 rounded-2xl border border-blue-100 bg-blue-50/50 animate-pulse" aria-hidden />
        }
      >
