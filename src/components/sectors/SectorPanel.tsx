      ...
      >
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-5">
          <div className="bg-white/80 rounded-xl border border-blue-100 p-4">
            <div className="text-[11px] uppercase tracking-wider text-blue-500 font-medium mb-1">
              Taille du marché
            </div>
            <p className="text-blue-950 text-sm font-light leading-relaxed">
        ...
        <div className="mb-4">
          <div className="text-[11px] uppercase tracking-wider text-blue-500 font-medium mb-2">
            Acteurs majeurs
          </div>
