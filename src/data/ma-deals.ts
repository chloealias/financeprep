...
const MA_DEALS_RAW: Omit<MaDeal, 'sectorId'>[] = [
  {
    ...
    advisors: {
      sellSide: ['Rothschild & Co (M&A lead)', 'Bank of America', 'BNP Paribas', 'Goldman Sachs', 'Morgan Stanley'],
      buySide: ['Lazard (M&A)', 'Citigroup (M&A + financing)'],
      other: [
        {
          label: 'Coordinateurs dette',
          banks: ['Citi', 'Goldman Sachs', 'Barclays', 'BNP Paribas', 'Morgan Stanley', 'Société Générale', 'HSBC'],
        },
      ],
    },
    interests: [
    ...
    advisors: {
      ...
      other: [
        ...
        },
        {
          ...
          banks: ['Elliott', 'Anchorage', 'Sona', 'Sculptor (secured)', 'Arini (holdco)', 'Pimco', 'BlackRock', 'Fidelity'],
        },
      ],
    },
    interests: [
  ...
  },
  {
    ...
    valorisation: [
      ...
      { label: 'État allemand', value: 'Détient ~12% de Commerzbank (reliquat sauvetage 2008), opposé au rachat' },
    ],
    advisors: {},
    interests: [
      {
  ...
  },
  {
    ...
    valorisation: [
      { label: 'Impact total', value: '~900 M€ CA déconsolidé, ~200 M€ EBITDA, ~30% des effectifs' },
    ],
    advisors: {
  ...
  },
  {
    ...
    valorisation: [
      ...
      { label: 'Multiple', value: '~12,4x revenue (Kering Beauté : ~323 M€ CA 2024, dont Creed en forte croissance)' },
    ],
    advisors: {
  ...
  },
  {
    ...
    advisors: {
      buySide: ['Evercore', 'Deutsche Bank', 'JPMorgan (M&A)', 'Legance', 'White & Case', 'Sullivan & Cromwell (legal)', 'PwC (due diligence)'],
  ...
  },
  {
    ...
    valorisation: [
      { label: 'EV', value: '20,35 Md€ (hors earn-out)' },
    ],
    advisors: {
