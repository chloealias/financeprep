...
export const BANK_LIST: BankProfile[] = [
  {
    ...
    recrutement:
      "Entretiens techniques + fit culturel. Cas M&A / restructuring. Stages très sélectifs, souvent via réseau et parcours top schools.",
    pointEntretien:
    ...
    dealEmblematique: {
      ...
      texte:
        "Sell-side M&A lead pour Sanofi sur le carve-out Opella (~16 Md€ EV). Deal emblématique du modèle conseil pur : pas de financement intégré, mais mandat stratégique sous pression politique (Doliprane).",
    },
    ...
    piegeAEviter:
      "Ne jamais confondre Rothschild & Co (Paris/Londres, advisory) avec Edmond de Rothschild (banque privée, Genève).",
  },
  {
    id: "lazard",
    categoryId: "elite-boutique",
    ...
    recrutement:
      "Plusieurs rounds, cas financiers et fit. Restructuring recrute des profils juridiques/finance dette en plus des généralistes.",
    pointEntretien:
    ...
    dealEmblematique: {
      ...
      texte:
        "Advisor restructuring côté débiteur (Altice / Drahi). Cooperation agreement entre ~200 créanciers secured, debt-for-equity, distinction secured vs holdco — cas d'école restructuring européen.",
    },
  ...
  },
  {
    ...
    recrutement:
      "Superday, entretiens comportementaux + techniques. Préparer DCF, comps, accretion/dilution. Stages analyst summer très compétitifs.",
    pointEntretien:
  ...
  },
  {
    ...
    recrutement:
      "Process similaire aux autres bulge : fit + technical. Questions brainteasers possibles.",
    pointEntretien:
      "Citer un deal où MS est bookrunner ou advisor. Comparer MS vs GS sur culture et secteurs forts (ECM, tech).",
    dealEmblematique: {
      titre: "Lineage Logistics — IPO (2024)",
      texte:
        "Bookrunner sur la plus grande IPO mondiale 2024 (~18 Md$). MS illustre la force ECM / equity capital markets en plus des grands M&A.",
    },
  ...
  },
  {
    ...
    pointEntretien:
      "Comprendre le modèle universal bank : avantages (financement intégré) vs conflits potentiels. Deal récent en Europe.",
    dealEmblematique: {
      titre: "Swisscom / Vodafone Italia → Fastweb",
      texte:
        "Buy-side M&A advisor avec Evercore et Deutsche Bank sur l'acquisition Vodafone Italia (~8 Md€ EV). Consolidation telecom européenne, enjeux antitrust.",
    },
    emblematicDealId: "d07",
    questionPiège: "JPMorgan peut-elle conseiller et prêter sur le même deal sans conflit ?",
    reponsePiège:
  ...
  },
  {
    ...
    recrutement:
      "Process standard bulge bracket. Attention aux questions comptables (BofA historiquement forte accounting).",
    pointEntretien:
      "Ne pas confondre avec Merrill Lynch (intégré). Citer deal luxe ou healthcare récent.",
    dealEmblematique: {
      titre: "Kering Beauté / Creed → L'Oréal",
      texte:
        "Buy-side advisor pour L'Oréal (4 Md€ cash, plus grande acquisition de l'histoire du groupe). Sell-side = Evercore + Centerview — BofA côté acquéreur.",
    },
  ...
  },
  {
    ...
    pointEntretien:
      "Mettre en avant l'angle international si profil multilingue. Deal avec rôle financing + advisory.",
    dealEmblematique: {
      titre: "Sanofi / Opella → CD&R",
      texte:
        "LBO ~16 Md€ : Citi buy-side M&A lead + coordinateur dette (club avec GS, Barclays, BNP, MS, SocGen, HSBC). Modèle integrated advisory + financing.",
    },
    emblematicDealId: "d01",
    questionPiège: "Sur Opella, pourquoi autant de banques en coordinateurs dette ?",
    reponsePiège:
  ...
  },
  {
    ...
    pointEntretien:
      "Si entretien Paris : expliquer le lien Barclays-Londres. Connaître un deal Lev Fin ou UK-centric.",
    dealEmblematique: {
      titre: "Sanofi / Opella → CD&R",
      texte:
        "LBO ~16 Md€ : Barclays coordinateur dette (Term Loan B, bridge HY). Angle Lev Fin européen sur un carve-out flagship.",
    },
    emblematicDealId: "d01",
  ...
  },
  {
    ...
    recrutement:
      "Process FR : entretiens RH + techniques, parfois test logique. Stages CIB très demandés.",
    pointEntretien:
      "Argument « banque de référence en France ». Deal Opella ou autre flagship FR. Comparer avec Rothschild (conseil pur).",
    dealEmblematique: {
      titre: "Sanofi / Opella → CD&R",
      texte:
        "Sell-side advisor + coordinateur dette sur Opella. BNP = banque de référence sur les grands mandats français, conseil et financement intégrés.",
    },
    emblematicDealId: "d01",
  ...
  },
  {
    ...
    recrutement:
      "Concours et entretiens type grande banque FR. Bien préparer motivation groupe + division CIB.",
    pointEntretien:
      "Montrer connaissance du GBIS. Éviter de ne parler que de M&A si candidature markets/IB mixte.",
    dealEmblematique: {
      titre: "Sanofi / Opella → CD&R",
      texte:
        "Coordinateur dette sur le LBO Opella. SocGen illustre la force financing du groupe, en complément des desks derivatives.",
    },
    emblematicDealId: "d01",
    emblematicLinkType: "bank",
    questionPiège: "Pourquoi postuler en M&A chez SocGen plutôt qu'en derivatives ?",
    reponsePiège:
  ...
  },
  {
    ...
    pointEntretien:
      "Si profil international : mettre en avant lien Europe-Asie. Sinon citer rôle financing sur deal européen.",
    dealEmblematique: {
      titre: "Sanofi / Opella → CD&R",
      texte:
        "Coordinateur dette sur Opella. HSBC apporte son réseau global de distribution dette, même si le deal est centré France/Europe.",
    },
    emblematicDealId: "d01",
    emblematicLinkType: "bank",
  ...
  },
  {
    ...
    dealEmblematique: {
      titre: "Swisscom / Vodafone Italia → Fastweb",
      texte:
        "Sell-side M&A advisor sur l'acquisition Vodafone Italia (~8 Md€ EV). UBS illustre le conseil cross-border telecom Europe.",
    },
    emblematicDealId: "d07",
    questionPiège: "UBS a racheté Credit Suisse — quel impact sur le recrutement M&A ?",
    reponsePiège:
  ...
  },
  {
    ...
    pointEntretien:
      "Connaître la stratégie « return to profitability ». Deal telecom ou German Mittelstand angle.",
    dealEmblematique: {
      titre: "Swisscom / Vodafone Italia → Fastweb",
      texte:
        "Buy-side M&A advisor avec Evercore et JPM sur Vodafone Italia (~8 Md€ EV). DB = relais naturel sur les mandats telecom et cross-border Europe.",
    },
    emblematicDealId: "d07",
  ...
  },
  {
    ...
    recrutement:
      "Entretiens techniques (DCF, comps) + fit. Stages très sélectifs à Paris et Londres.",
    pointEntretien:
    ...
    dealEmblematique: {
      titre: "Kering Beauté / Creed → L'Oréal",
      texte:
        "Sell-side advisor avec Centerview (~4 Md€ cash). Deal emblématique du positionnement Evercore sur le luxe et les cessions stratégiques sous pression bilancielle.",
    },
    emblematicDealId: "d06",
    questionPiège: "Evercore peut-elle financer un LBO comme BNP sur Opella ?",
    reponsePiège:
  ...
  },
  {
    ...
    recrutement:
      "Process très sélectif, fit culturel et cas M&A approfondis. Réseau alumni prestigieux.",
    pointEntretien:
    ...
    dealEmblematique: {
      titre: "Kering Beauté / Creed → L'Oréal",
      texte:
        "Sell-side avec Evercore sur la plus grande acquisition de l'histoire de L'Oréal. Illustre le positionnement Centerview sur les sell-side « trophy ».",
    },
    emblematicDealId: "d06",
    questionPiège: "Centerview et Evercore — pourquoi deux boutiques sur le même sell-side ?",
    reponsePiège:
  ...
  },
  {
    ...
    recrutement:
      "Entretiens techniques dette + comptabilité. Profils appréciés : juridique, finance structurée, M&A.",
    pointEntretien:
    ...
    dealEmblematique: {
      titre: "Altice France — Restructuration €24 Md",
      texte:
        "Advisor restructuring côté créanciers holdco (~4,4 Md€). Complémentaire de Lazard (débiteur) et Rothschild (secured) — cas d'école des mandats multi-advisors.",
    },
    emblematicDealId: "d02",
    questionPiège: "Houlihan Lokey conseille-t-elle Patrick Drahi ou les créanciers ?",
    reponsePiège:
  ...
  },
  {
    ...
    recrutement:
      "Recrutement désormais via UBS. Connaître l'historique CS reste indispensable pour les entretiens IB suisses.",
    pointEntretien:
    ...
    piegeAEviter:
      "Ne pas confondre Credit Suisse avec Crédit Agricole (France) ni avec UBS post-merger.",
  },
  {
    id: "mediobanca",
    categoryId: "universal-bank",
    ...
    recrutement:
      "Process italien + entretiens en anglais. Cas M&A et motivation Italie/Europe sud.",
    pointEntretien:
    ...
    dealEmblematique: {
      ...
      texte:
        "Contexte consolidation bancaire européenne — Mediobanca suit de près les OPA transfrontalières comme advisor historique du secteur FIG italien.",
    },
    emblematicDealId: "d04",
    questionPiège: "Mediobanca est-elle une boutique ou une banque universelle ?",
    reponsePiège:
  ...
  },
  {
    ...
    dealEmblematique: {
      titre: "UniCredit / Commerzbank (2024-2026)",
      texte:
        "Natixis CIB suit la consolidation FIG européenne — référence pour les entretiens banque France sur les OPA transfrontalières et la souveraineté bancaire allemande.",
    },
    emblematicDealId: "d04",
    questionPiège: "Natixis et BPCE, quelle différence ?",
    reponsePiège:
  ...
  },
  {
    ...
    recrutement:
      "Process FR standard. Tests logique + entretiens techniques. Stages CIB Paris très demandés.",
    pointEntretien:
    ...
    dealEmblematique: {
      titre: "Sanofi / Opella → CD&R",
      texte:
        "Présent sur l'écosystème des grands deals français en financing — à distinguer du rôle sell-side lead de Rothschild sur Opella.",
    },
    emblematicDealId: "d01",
    emblematicLinkType: "bank",
    questionPiège: "Crédit Agricole CIB et Crédit Agricole retail, c'est la même entité ?",
    reponsePiège:
  ...
  },
  {
    ...
    recrutement:
      "Entretiens techniques + fit entrepreneurial. Moins de « prestige branding » que GS — compensé par responsabilités rapides.",
    pointEntretien:
    ...
    dealEmblematique: {
      titre: "Goldman Sachs Alternatives / Mace Consult",
      texte:
        "Buy-side M&A advisor avec Lazard sur le carve-out Mace (~$1 Md rev.). Illustre le positionnement Jefferies sur les deals mid-cap et PE-sponsored.",
    },
    emblematicDealId: "d03",
    questionPiège: "Jefferies est-elle une bulge bracket ?",
    reponsePiège:
  ...
  },
  {
    ...
    recrutement:
      "Entretiens fit + cas infra/PE. Profils appréciés : ingénierie, infra, finance structurée.",
    pointEntretien:
    ...
    dealEmblematique: {
      ...
      texte:
        "Vendeur (Macquarie AM) sur le carve-out autoroutier indien (~1,6 Md$). Cas d'école rotation de portefeuille infra.",
    },
    emblematicDealId: "d10",
    questionPiège: "Macquarie est-elle une banque d'investissement classique ?",
    reponsePiège:
  ...
  },
  {
    ...
    dealEmblematique: {
      ...
      texte:
        "Oddo BHF conseille les ETI et mid-cap familiales franco-allemandes — segment peu couvert par les bulge, complémentaire aux mega-deals de l'actualité M&A.",
    },
    questionPiège: "Oddo BHF est-elle une boutique ou une banque universelle ?",
    reponsePiège:
