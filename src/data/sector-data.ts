...
export const SECTOR_DATA: Record<SectorId, SectorSheetData> = {
  tmt: {
    ...
    panorama: {
      ...
      segmentsCles: ['SaaS B2B', 'Telecom convergent', 'Semi & cloud infra', 'Streaming & gaming', 'Cybersécurité'],
    },
    ...
    deal: {
      ...
      texte: 'Consolidation telecom européenne (~8 Md€ EV, ~6x EBITDA). Swisscom crée un challenger convergent en Italie face à TIM et Iliad. Enjeux antitrust majeurs.',
    },
  ...
  sante: {
    ...
    panorama: {
      ...
      volumeMa: '~1 200 deals M&A santé/an mondiaux ; Europe ~280 deals/an >25 M$ (bolt-on biotech dominant)',
      acteursMajeurs: [
      ...
      segmentsCles: ['Big Pharma', 'Biotech pré-revenus', 'Medtech', 'Consumer health / OTC', 'Services & CRO'],
    },
  ...
  energie: {
    ...
    panorama: {
      ...
      volumeMa: '~450 deals O&G/an mondiaux >100 M$ ; renouvelables ~180 deals/an >50 M$ (consolidation accélérée)',
      acteursMajeurs: [
      ...
      segmentsCles: ['Upstream O&G', 'Midstream', 'Utilities régulées', 'Éolien / solaire', 'Nucléaire & grids'],
    },
  ...
  retail: {
    ...
    panorama: {
      ...
      volumeMa: '~900 deals consumer & retail/an mondiaux >50 M$ ; Europe ~220 deals/an (luxe & beauté très actifs)',
      acteursMajeurs: [
      ...
      segmentsCles: ['FMCG marques', 'Luxe & beauté', 'Grande distribution', 'E-commerce', 'Food service'],
    },
    ...
    deal: {
      ...
      texte: "4 Md€ cash — plus grande acquisition de l'histoire de L'Oréal. Licences Gucci/Balenciaga/Bottega sur 50 ans. Multiple ~12x revenue.",
    },
  ...
  industrie: {
    ...
    panorama: {
      ...
      volumeMa: '~1 500 deals industriels/an mondiaux >50 M$ ; Europe ~400 deals/an (défense en forte hausse post-2022)',
      acteursMajeurs: [
      ...
      segmentsCles: ['Aéro & défense', 'Machines & automation', 'Chimie', 'Construction & EPC', 'Services industriels'],
    },
    ...
    deal: {
      ...
      texte: 'Carve-out consulting infra (~$1 Md rev.). GS Alternatives acquiert 75% — UBS sell-side. Illustre la prime des pure-play consulting vs contracting.',
    },
  ...
  immo: {
    ...
    Icon: Building,
    panorama: {
      tailleMarche: '~340 000 Md$ d\'actifs immobiliers mondiaux ; marché transactionnel ~1 200 Md$/an (cycle-dépendant)',
      volumeMa: '~350 deals immo/an mondiaux >100 M$ (2024-25 en reprise après correction taux) ; logistique & data centers les plus actifs',
      acteursMajeurs: [
      ...
      segmentsCles: ['Bureaux', 'Logistique', 'Résidentiel', 'Retail immo', 'Data centers & infra spécialisée'],
    },
    ...
    Icon: Landmark,
    panorama: {
      tailleMarche: '~35 000 Md€ d\'actifs bancaires zone euro ; assurance mondiale ~6 000 Md$ primes',
      volumeMa: '~120 deals FIG/an en Europe >100 M$ (banques, asset managers, assurance) ; consolidation bancaire accélérée (UniCredit/CBK)',
      acteursMajeurs: [
      ...
      segmentsCles: ['Banques universelles', 'Banques d\'investissement', 'Assurance', 'Asset management', 'Fintech / payments'],
    },
