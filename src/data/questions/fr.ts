export const questions = [
  // ===== VALORISATION =====
  {
    ...
    explanation:
      "Question fondamentale qui teste la connaissance des méthodes intrinsèques et extrinsèques. L'enjeu est de montrer la maîtrise des trois grandes familles et leurs cas d'usage.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question classique qui teste la compréhension de la différence entre Enterprise Value et Equity Value, et de l'impact de la structure financière.",
    steps: [
      ...
      "L'EV/EBITDA reste le standard en M&A, y compris en industrie capitalistique (industrie, télécoms). On le croise avec EV/EBIT ou EV/(EBITDA−CAPEX) quand le CAPEX/D&A distord la comparabilité.",
      "Limites de l'EBITDA : il ignore le CAPEX (critique pour les industries lourdes) et les variations de BFR — d'où ces multiples complémentaires.",
    ],
  ...
  },
  {
    ...
    explanation:
      "Question incontournable qui teste la maîtrise du pont EV-Equity, central dans toute valorisation.",
    steps: [
  ...
  // ===== DCF =====
  {
    ...
    explanation:
      "Question reine en M&A. Il faut être structuré, méthodique, et maîtriser chaque composant. Un DCF mal expliqué = entretien terminé.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question technique très fréquente. Il faut connaître la formule, comprendre chaque composant et savoir où trouver les données.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question discriminante qui teste la rigueur conceptuelle. Confondre les deux mène à des erreurs majeures de valorisation.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question de jugement qui montre votre recul critique. Les meilleurs candidats ne défendent pas aveuglément leurs modèles.",
    steps: [
  ...
  // ===== M&A =====
  {
    ...
    explanation:
      "Question de structuration qui teste votre vision globale du process. À répondre côté sell-side (vendeur), souvent plus complet.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question apparemment simple mais qui teste les nuances juridiques et financières.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question d'accrétion-dilution (A/D analysis), classique en M&A pour évaluer l'impact d'une acquisition sur le BPA de l'acquéreur.",
    steps: [
      ...
      "Règle simple (paiement actions) : relutive si P/E de l'acquéreur > P/E de la cible (l'acquéreur émet des actions valorisées cher pour acquérir des bénéfices bon marché).",
  ...
  },
  {
    ...
    explanation:
      "Question stratégique qui teste votre compréhension de la création de valeur en M&A. Les synergies justifient souvent le prix payé.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question très technique sur les mécanismes de prix en M&A. Discriminante en entretien M&A senior.",
    steps: [
  ...
  // ===== LBO =====
  {
    ...
    explanation:
      "Question fondamentale en private equity. Il faut maîtriser le concept, les acteurs, et les leviers de création de valeur.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question de jugement business très posée en private equity. Il faut montrer qu'on comprend ce qui rend une entreprise 'leverageable'.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question technique avancée. À structurer en bloc, montrer la logique et les outputs clés (TRI, MOIC).",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question stratégique fondamentale en PE. Permet d'analyser les sources de TRI et leurs proportions.",
    steps: [
  ...
  // ===== TRANSACTION SERVICES =====
  {
    ...
    explanation:
      "Question de base en TS. Il faut montrer qu'on comprend l'objectif (sécuriser l'acquéreur) et les principaux livrables.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Concept central en TS, c'est LE livrable phare d'une DD financière. À maîtriser absolument.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question pratique très posée en TS. Le Net Debt impacte directement le prix payé par l'acquéreur (Equity Value = EV − Net Debt).",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Sujet technique avancé en TS. Le BFR normatif impacte directement le prix dans un mécanisme de Completion Accounts.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question stratégique sur le process M&A. Montre que vous comprenez les enjeux côté vendeur et acheteur.",
    steps: [
  ...
  // ===== COMPTABILITE =====
  {
    ...
    explanation:
      "Question reine en finance. Si vous ratez ça, vous échouez. À pratiquer jusqu'à automatisme total.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question conceptuelle qui teste votre compréhension de la différence entre profit comptable et cash réel.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question fréquente en M&A. Le goodwill est central dans la comptabilisation des acquisitions.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question d'actualité (norme appliquée depuis 2019). Très posée car impacte les multiples de valorisation et les ratios de dette.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question opérationnelle clé en TS et M&A. Le BFR est souvent un piège dans les deals.",
    steps: [
  ...
  // ===== AUTRES =====
  {
    ...
    explanation:
      "Question méthodologique pour les analyses par multiples. Un mauvais échantillon biaise toute la valorisation.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question juridico-financière sur la sécurisation des deals. Devenue cruciale post-COVID.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question sur les mécanismes de prix conditionnels. Très utilisés dans les deals où le vendeur reste opérationnel.",
    steps: [
  ...
  // ===== QUESTIONS TECHNIQUES SUPPLEMENTAIRES =====
  {
    ...
    explanation:
      "Question piège classique chez Rothschild et Lazard. Teste votre capacité à raisonner et à ne pas tomber dans les conclusions hâtives.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question piège récurrente chez les boutiques. Teste la compréhension fine du lien entre cash et Enterprise Value.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question apparemment simple mais qui teste votre intuition et votre capacité à hiérarchiser les méthodes.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question conceptuelle fréquente. Teste la compréhension profonde de l'EV vs Equity Value.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "intermédiaire",
    question:
      "Deux entreprises sont identiques sauf que l'une est endettée et l'autre non. Laquelle a le WACC le plus élevé ?",
    explanation:
      "Question conceptuelle sur la théorie de Modigliani-Miller. Très posée pour tester votre solidité théorique.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "avancé",
    question:
      "Comment calcule-t-on le Beta et que signifie-t-il ? Classez Peugeot, EDF, Samsung, Total du beta le plus faible au plus élevé",
    explanation:
      "Question type AlumnEye / Crack-It. Teste la compréhension du Beta + l'intuition sur les secteurs.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question type AlumnEye qui teste la règle simple sur l'accrétion-dilution en deal 100% actions.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question structurelle classique en PE. Hiérarchie des dettes à maîtriser absolument.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "avancé",
    question:
      "Qu'est-ce qui se passe si on verse des dividendes chaque année dans un LBO au lieu de rembourser la dette ?",
  ...
  },
  {
    ...
    explanation:
      "Question fondamentale en M&A et TS. À maîtriser pour comprendre les comptes consolidés.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question pratique en TS. Aborde la fiabilité du chiffre d'affaires, élément central de toute valorisation.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Mécanisme standard en M&A. Question avancée qui teste la compréhension fine des mécanismes de prix.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question juridico-fiscale. Choix structurant qui impacte le prix, la fiscalité et le risque.",
    steps: [
  ...
  // ===== QUESTIONS DESTABILISANTES / BRAINTEASERS =====
  {
    ...
    explanation:
      "Brainteaser CULTE (Goldman Sachs, McKinsey). Pas de bonne réponse — l'évaluation porte sur la méthodologie, le calme et la structuration.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "avancé",
    question:
      "On a 12 boules identiques sauf une plus lourde. En 3 pesées, comment trouver la différente ?",
    explanation:
      "Énigme logique CULTE (Wall Street Oasis, banques d'affaires). Teste la pensée structurée et la décomposition de problème.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "intermédiaire",
    question:
      "Bactérie qui double chaque minute, remplit un bocal en 1h. À quelle minute le bocal est-il à moitié plein ?",
    explanation:
      "Brainteaser sur le raisonnement exponentiel. Très posé en banque pour tester l'intuition mathématique.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Énigme géométrique reposée par Goldman Sachs en 2024. Piège classique sur le mouvement de l'aiguille des heures.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "avancé",
    question:
      "Vous avez 100 boules (50 noires, 50 blanches) et 2 seaux. Comment maximiser la probabilité de tirer une blanche ?",
  ...
  },
  {
    ...
    explanation:
      "Question de calcul mental Goldman Sachs. Teste votre vivacité et vos techniques de calcul rapide.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "avancé",
    question:
      "Vous êtes en finale d'un jeu : 3 enveloppes (1 offre, 2 refus). Vous en choisissez une. L'intervieweur en élimine une qui contenait un refus. Vous changez ou pas ?",
    explanation:
      "Le célèbre 'Monty Hall problem'. Question de probabilité conditionnelle qui prend toujours au piège.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Énigme logique très posée en banque (et dans Die Hard 3). Teste votre capacité à résoudre par étapes.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Market sizing type ENPC / Polytechnique. Sizing B2C avec plusieurs étapes de raisonnement.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "avancé",
    question:
      "Combien je suis prêt à payer pour jouer à un jeu où je tire un dé jusqu'à un 6 et gagne 100€ × le nombre de tirs ?",
    explanation:
      "Question d'arbitrage probabiliste posée en M&A et trading. Calcul d'espérance mathématique.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question fit piège. La réponse « je suis perfectionniste » est ÉLIMINATOIRE. Les recruteurs attendent de l'honnêteté et de la maturité.",
    steps: [
      "Erreur fatale 1 : la fausse modestie déguisée. « Je suis perfectionniste / trop bosseur / trop exigeant. » → cliché détecté en 2 secondes, signal de manque de self-awareness.",
      ...
      "Bonne approche : identifier une vraie faiblesse « gérable », montrer la conscience qu'on en a, et expliquer ce qu'on fait pour la corriger.",
      ...
      "Catégorie 2 — Soft skill : « J'ai tendance à vouloir tout faire moi-même au lieu de déléguer. Sur [expérience], j'ai appris à mieux distribuer les tâches. » — exemples M&A/PE : « J'ai du mal à déléguer, je préfère vérifier moi-même les modèles » → montre rigueur ; « Je suis très focus sur les détails, parfois au détriment du big picture » → adapté à un junior.",
      "Catégorie 3 — Trait de personnalité : « J'ai du mal à dire non, ce qui m'a parfois conduit à m'éparpiller. J'apprends à prioriser plus rigoureusement. » Autre angle : « J'accepte difficilement la critique sur le moment, mais j'y reviens à froid pour m'améliorer. »",
      ...
      "Structure idéale : (1) Énoncer le défaut clairement, (2) Donner un exemple concret, (3) Expliquer comment vous travaillez à l'améliorer. Ton honnête, posé, sans dramatiser.",
      "À éviter ABSOLUMENT : « Je n'ai pas vraiment de défauts » (arrogance), « C'est dur de répondre » (esquive), citer 5 défauts (auto-sabotage), aveux trop intimes.",
    ],
    tip: "Préparer 2-3 faiblesses solides AVANT l'entretien. Cette question tombe dans ~60 % des entretiens — l'improvisation est suicidaire.",
  },
  {
    id: 59,
    interviewSlot: "fit",
    ...
    explanation:
      "Question fit déstabilisante posée en final round. Test de confiance, de self-awareness et d'argumentation commerciale.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question incontournable en M&A senior. Test de la veille, de la compréhension stratégique et de la capacité à structurer un récit.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question piège déstabilisante. La réponse révèle votre compréhension réelle des métiers et votre cohérence.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question OVNI. Teste la créativité, la self-awareness, et la capacité à se vendre sous un angle inattendu.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question cruelle posée en final round, parfois après 30 minutes de questions. Test de résilience et de self-awareness.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Estimation type Heard on the Street. Pas de connaissance préalable requise — pure logique.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "avancé",
    question:
      "Une corde fait le tour de la Terre. On rajoute 1 mètre. La corde flotte à quelle hauteur du sol ?",
    explanation:
      "Brainteaser géométrique contre-intuitif posé chez Goldman et JPM. Test du raisonnement vs intuition.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question fit fondamentale. La pire réponse est générique. Les bons candidats font leurs devoirs.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "avancé",
    question:
      "Pourquoi un acquéreur stratégique paie-t-il généralement plus qu'un acquéreur financier ?",
    explanation:
      "Question fondamentale qui teste la compréhension des dynamiques d'enchères et de la création de valeur.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question de structuration en LBO. Maîtriser le MEP est différenciant en entretien PE.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question pratique en TS / DD. Le business plan est l'élément le plus contesté en M&A.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question de process M&A. Permet de tester votre connaissance des risques d'exécution.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Exercice CULTE en M&A. À maîtriser en 30 secondes top chrono. Si vous le ratez, l'entretien est terminé.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question de positionnement métier en TS. Permet de comprendre les enjeux et angles d'approche différents.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question conceptuelle qui teste la compréhension fine de la structure de financement.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question stratégique sur le pricing de l'industrie PE. Très posée pour distinguer les vrais passionnés.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "avancé",
    question:
      "Quelles sont les différences entre un process compétitif (auction) et un process bilatéral ?",
  ...
  },
  {
    ...
    explanation:
      "Question conceptuelle profonde. Test la compréhension de la nature 'situationnelle' de la valeur.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "intermédiaire",
    question:
      "Vous avez 8 minutes pour faire bouillir un œuf de 4 minutes avec 2 sabliers (4 et 7 minutes). Comment faire ?",
  ...
  },
  {
    ...
    explanation:
      "Question de stats / probabilités posée en hedge funds et trading. Évalue la maîtrise des intervalles de confiance.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "intermédiaire",
    question:
      "Comment compareriez-vous deux entreprises A et B pour décider laquelle investir en LBO ?",
    explanation:
      "Question PE très classique posée pour tester votre framework d'analyse. La structure de réponse compte autant que le contenu.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question qui distingue les vrais passionnés du PE des candidats théoriques. Soyez concret et donnez des exemples.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question de cycle d'investissement PE. Permet de tester votre compréhension des dynamiques de marché.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question quantitative qui teste votre intuition modélistique. Les bonnes réponses citent des sensibilités chiffrées.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question modèle M&A. Permet de tester votre compréhension des mécanismes accretion/dilution.",
    steps: [
      "Élément 1 — Prix d'achat : EV de la cible + prime de contrôle (15-30% typique sur cours coté). Source de discussion clé.",
      "Élément 2 — Form of consideration : cash, actions, mixte. Impact direct sur l'accretion/dilution. Cash = relutif si P/E cible < 1/Kd_aftertax (rendement de la cible > coût de la dette après impôt). Actions = relutif si P/E acquéreur > P/E cible ; dilutif si P/E acquéreur < P/E cible.",
  ...
  },
  {
    ...
    explanation:
      "Question piège classique posée pour tester votre rapidité de raisonnement et votre intuition financière.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question TS / due diligence critique. Le BFR normatif est l'un des deux ajustements de prix les plus importants (avec le Net Debt).",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question quasi systématique en entretien M&A. Démontre votre veille, votre capacité d'analyse et votre passion.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Pas de DCF classique possible. On utilise EV/Sales, EV/ARR (SaaS), la méthode VC (rétro-projection depuis la valeur de sortie), ou un DCF long horizon avec courbe en J. Pourquoi : sujet brûlant en PE et VC, teste la capacité à adapter la boîte à outils standard.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — C'est l'écart entre le prix payé et le cours de bourse avant rumeur. Typiquement 25-40% pour une cible cotée. Elle paie le contrôle, les synergies attendues, et \"convainc\" les actionnaires de vendre. Pourquoi : question structurante en M&A.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Le trading comp regarde les multiples des concurrents cotés en bourse aujourd'hui. Le precedent transaction regarde les multiples auxquels des concurrents ont été VENDUS. Le 2e est plus élevé car il inclut la prime de contrôle. Pourquoi : distinction cruciale en M&A.",
    steps: [
  ...
  // ===== NOUVELLES QUESTIONS — DCF (Q96-Q99) =====
  {
    ...
    explanation:
      "En une phrase — Deux méthodes : Gordon-Shapiro (perpétuité à croissance g) ou Multiple de sortie (EV/EBITDA × EBITDA terminal). On présente toujours les deux. Pourquoi : la valeur terminale fait 60-80% de la valeur DCF — mal la calculer = mal valoriser.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      'En une phrase — Par défaut on actualise comme si tous les flux tombaient le 31 décembre. La mid-year convention dit : "En vrai, le cash tombe en continu pendant l\'année". On divise par (1+WACC)^(n−0.5). Résultat : valeur ~5% plus élevée. Pourquoi : détail technique qui distingue les bons candidats.',
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — La valeur baisse fortement : typiquement 10-20% pour 100 bps de WACC en plus. Les flux lointains sont actualisés davantage et surtout la valeur terminale (60-80% de l'EV) chute mécaniquement. Pourquoi : question de sensibilité fréquente.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — En théorie variable (la structure de capital évolue), en pratique constant pour simplifier. Sauf en LBO où la dette se rembourse vite : on utilise alors l'APV (Adjusted Present Value). Pourquoi : question avancée, distingue ceux qui ont lu Damodaran.",
    steps: [
  ...
  // ===== NOUVELLES QUESTIONS — COMPTABILITÉ (Q100-Q106) =====
  {
    ...
    explanation:
      'En une phrase — P&L : EBITDA +100, Résultat net +75 (après IS à 25%). Bilan : Cash +75, Equity +75. Cash flow : CFO +75. Pourquoi : variante classique du "walk me through the financial statements", teste la maîtrise complète des liens entre états.',
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — C'est de l'impôt \"décalé\" dans le temps. Il apparaît quand les règles comptables et fiscales divergent (ex : amortissement 10 ans en compta vs 5 ans en fiscal → moins d'impôt aujourd'hui = DTL). Pourquoi : sujet incontournable en TS et audit.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — C'est une charge comptable (étalée sur la période d'acquisition) qui dilue les actionnaires. P&L : charge non-cash. Bilan : augmentation des réserves. Valorisation : retraitement via méthode du Treasury Stock pour le diluted EPS. Pourquoi : sujet en pleine actualité (tech, SaaS).",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — En IFRS, la recherche est en charge, le développement peut être immobilisé si 6 critères sont remplis. En US GAAP, tout est en charge sauf logiciels. Pourquoi : question avancée typique audit/TS, demande une connaissance technique précise des normes.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Maintenance = remplacer une machine cassée pour rester à isopérimètre. Croissance = augmenter capacité ou entrer sur un nouveau marché. Distinction cruciale en LBO et DCF. Pourquoi : distinction clé en PE et TS.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Le goodwill ne s'amortit pas, mais on teste chaque année s'il vaut toujours sa valeur comptable. On compare valeur recouvrable (max entre fair value et value in use) à la valeur comptable de la CGU. Si inférieure → on déprécie. Irréversible. Pourquoi : question avancée audit/TS.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — 5 étapes : (1) identifier le contrat, (2) identifier les obligations de performance, (3) déterminer le prix, (4) allouer le prix, (5) reconnaître le revenu quand chaque obligation est satisfaite. Pourquoi : norme majeure depuis 2018, question typique audit/TS.",
    steps: [
  ...
  // ===== NOUVELLES QUESTIONS — M&A (Q107-Q111) =====
  {
    ...
    explanation:
      "En une phrase — Quand on achète une entreprise, on doit réallouer le prix payé entre les actifs identifiables (machines, marques, contrats clients) à leur juste valeur, et le reste devient du goodwill. Pourquoi : sujet technique très posé en TS et audit.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Deux familles : synergies de revenus (cross-selling, pricing power) et synergies de coûts (suppression de doublons, économies d'échelle). Les synergies de coûts sont 2x plus fiables. Toujours présenter en valeur actualisée. Pourquoi : question fondamentale en M&A.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Conditions à remplir entre signing et closing : autorisations antitrust, financement, autorisations sectorielles, MAC clause, conditions opérationnelles. Pourquoi : question juridico-financière fréquente, teste la phase entre signing et closing.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — All-cash : prix certain, levier financier. All-stock : préserve le cash mais dilue. Mixte : combine. Le choix dépend de la valorisation relative, du levier, et du désir de partager le risque post-deal. Pourquoi : question stratégique avancée.",
    steps: [
      ...
      "Impact accretion/dilution : all-cash est plus relutif si le rendement après-impôt du cash (coût de la dette × (1−t)) < earnings yield de la cible (1/P/E ou NI/Prix).",
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Break-up fee : indemnité que la CIBLE paie à l'acheteur si elle se retire. Reverse break-up fee : indemnité que l'ACHETEUR paie si LUI se retire (souvent en cas de problème antitrust). Niveau typique : 2-5% de l'EV. Pourquoi : concept juridique fréquemment demandé en M&A.",
    steps: [
  ...
  // ===== NOUVELLES QUESTIONS — LBO (Q112-Q117) =====
  {
    ...
    explanation:
      "En une phrase — MOIC = combien de fois on a multiplié son investissement (cash out / cash in). TRI = rendement annualisé en %. Cibles standards en PE : MOIC 2,5-3x sur 5 ans, TRI 20-25%. Pourquoi : métriques fondamentales du PE, question quasi systématique.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — 3 leviers : (1) Croissance d'EBITDA, (2) Multiple expansion, (3) Debt paydown. Sur un deal réussi, la croissance d'EBITDA fait typiquement 50% de la création de valeur. Pourquoi : question structurante en PE.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Engagements financiers que la cible doit respecter pour garder son financement (Dette/EBITDA < 5x, EBITDA/Intérêts > 2x). Si breach, les banques peuvent exiger remboursement anticipé. Pourquoi : question avancée en LBO et structured finance.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Mezzanine : dette subordonnée (entre senior et equity), plus chère (10-15%), souvent avec warrants. PIK (Payment In Kind) : intérêts payés non en cash mais en nouvelle dette → préserve le cash. Pourquoi : question avancée sur la structuration LBO.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Le fonds PE re-leverage la cible (nouvelle dette) pour se reverser un dividende exceptionnel. Permet de cristalliser une partie du TRI sans vendre. Pourquoi : stratégie de PE très d'actualité, montre une vision approfondie du modèle.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Un fonds PE vend à un autre fonds PE. C'est désormais 40-50% des sorties en Europe. Beaucoup de dry powder, peu de cibles, et les fonds spécialisés peuvent encore créer de la valeur. Pourquoi : tendance majeure du PE.",
    steps: [
  ...
  // ===== NOUVELLES QUESTIONS — TS (Q118-Q122) =====
  {
    ...
    explanation:
      'En une phrase — Tableau qui détaille comment on passe de l\'EBITDA "reporté" à l\'EBITDA "ajusté" (normalisé) qui servira au calcul du prix. Chaque ligne = un ajustement (non-récurrent, pro-forma, mark-up). Pourquoi : LE livrable phare de la DD financière.',
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Analyse de la \"qualité\" du chiffre d'affaires : récurrent vs one-shot, par client, par produit, par géographie, churn, LTV, pricing power. Voir si le CA est solide et prévisible. Pourquoi : devenue centrale en 2020-2025 avec l'explosion du SaaS.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — À l'opposé du locked box, on calcule le prix EFFECTIF au jour du closing : prix négocié ajusté à la hausse/baisse selon dette nette et BFR REELS au closing. Process plus long mais plus juste. Pourquoi : question technique typique en TS et M&A.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Le vendeur récupère tout le cash de la cible avant la vente, et rembourse toute la dette. L'acheteur n'achète \"que\" l'opérationnel. Base de tout calcul de prix en M&A privé. Pourquoi : convention de marché incontournable.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — On calcule la moyenne du BFR sur 12-24 mois pour neutraliser la saisonnalité. On vérifie qu'il n'y a pas de window dressing. On retraite les éléments non récurrents pour obtenir un BFR \"normatif\" qui servira de target. Pourquoi : sujet pratique central en TS.",
    steps: [
  ...
  // ===== NOUVELLES QUESTIONS — FIT & BRAINTEASERS (Q123-Q130) =====
  {
    ...
    explanation:
      'En une phrase — Réponse en 3 temps : (1) ambition concrète à 5 ans, (2) compétences à acquérir, (3) ouverture sans donner l\'impression de "passer" par le poste. Pourquoi : question fit ultra classique, teste projection, ambition, cohérence avec le poste.',
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Choisir un VRAI échec (pas un faux modeste), analyser lucidement, expliquer les leçons apprises, montrer comment on a corrigé. Pourquoi : question fit révélatrice, teste honnêteté, capacité d'apprentissage, solidité psychologique.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — (1) reconnaître que la pression est inhérente au métier, (2) donner des stratégies concrètes (priorisation, sport, sommeil), (3) illustrer avec un exemple vécu. Pourquoi : M&A et audit sont des métiers extrêmes, le recruteur veut s'assurer que tu tiens.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Allocation rationnelle : 50-60% en actions (ETF monde), 20-30% en obligations/monétaire, 10-20% en thématique pour montrer une opinion. Évite d'être trop conservateur ou trop spéculatif. Pourquoi : test de bon sens financier, culture marchés, raisonnement sous contrainte.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Brain teaser d'estimation. Structurer en partant de la population ou du parc immobilier, faire des hypothèses chiffrées, conclure avec une fourchette. Réponse plausible : 50 000-80 000 intra-muros. Pourquoi : test de structuration mentale, le recruteur veut une démarche logique.",
    steps: [
  ...
  },
  {
    ...
    difficulty: "intermédiaire",
    question:
      "Un train Paris-Lyon dure 2h. Si je marche 5 km/h vers le wagon arrière pendant le trajet, quelle distance ai-je parcourue par rapport au sol ?",
    explanation:
      "En une phrase — Brain teaser de référentiel. Distance par rapport au sol = distance du train − distance marchée. TGV 200 km/h × 2h = 400 km. Moi : 5 km/h × 2h = 10 km en sens inverse → 390 km. Pourquoi : test de raisonnement physique, composition des vitesses.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      'En une phrase — Citer 2-3 différences spécifiques (positionnement, deals, culture) sans dénigrer le concurrent. Le test : montrer que tu as vraiment analysé le marché. Pourquoi : variante méchante du "pourquoi nous", le recruteur veut voir si tu as fait ton travail de différenciation.',
    steps: [
  ...
  },
  {
    ...
    explanation:
      "En une phrase — Choisir une entreprise spécifique, poser un diagnostic clair, proposer 2-3 actions concrètes avec un horizon de temps. Démontre la prise de hauteur et l'esprit stratégique. Pourquoi : question avancée fit/strat, teste vision business, hiérarchisation, lucidité.",
    steps: [
