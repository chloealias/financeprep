export const questions = [
  ...
  },
  {
    ...
    explanation:
      "Question piège déstabilisante. La 'mauvaise' réponse est éliminatoire dans 80% des cas. À préparer absolument.",
    steps: [
  ...
  },
  {
    ...
    explanation:
      "Question fit piège. La réponse 'je suis perfectionniste' est ELIMINATOIRE. Les recruteurs attendent de l'honnêteté et de la maturité.",
    steps: [
